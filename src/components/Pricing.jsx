...
const Pricing = () => {
    ...
    const packages = [
        {name: "Start", monthlyPrice: 50, yearlyPrice: 500, description: "A common form of Lorem ipsum reads: Lorem ipsum dolor sit amet, consectetur adipiscing elit.", green: "/src/assets/green.png"},
        {name: "Advance", monthlyPrice: 85, yearlyPrice: 850, description: "A common form of Lorem ipsum reads: Lorem ipsum dolor sit amet, consectetur adipiscing elit.", green: "/src/assets/green.png"},
        {name: "Premium", monthlyPrice: 100, yearlyPrice: 1000, description: "A common form of Lorem ipsum reads: Lorem ipsum dolor sit amet, consectetur adipiscing elit.", green: "/src/assets/green.png"}
    ]
